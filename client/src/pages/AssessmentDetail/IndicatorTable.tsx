        ...
        <Card key={group.dimensionName}>
          <CardHeader>
            <div className="flex items-center gap-3">
              <h3 className="text-lg font-semibold">{group.dimensionName}</h3>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-muted/30">
                    ...
                    <TableHead className="whitespace-nowrap max-w-[120px] hidden md:table-cell">
                      说明
                    </TableHead>
                    <TableHead className="whitespace-nowrap max-w-[120px] hidden lg:table-cell">
                      指标算法/描述
                    </TableHead>
                    <TableHead className="whitespace-nowrap max-w-[120px] hidden lg:table-cell">
                      数据来源
                    ...
                    <TableHead className="text-center w-28">自评</TableHead>
                    <TableHead className="text-center w-28">上级评分</TableHead>
                ...
                <TableBody>
                  {group.indicators.map((indicator) => (
                    <TableRow key={indicator.id}>
                      ...
                      <TableCell className="text-muted-foreground max-w-[120px] break-words hidden md:table-cell">
                        {indicator.description || '-'}
                      </TableCell>
                      <TableCell className="text-muted-foreground max-w-[120px] break-words hidden lg:table-cell">
                        {indicator.algorithm || '-'}
                      </TableCell>
                      <TableCell className="text-muted-foreground max-w-[120px] break-words hidden lg:table-cell">
